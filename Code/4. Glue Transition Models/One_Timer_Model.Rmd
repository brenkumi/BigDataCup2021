...
ggsave(filename = paste("One-Timer ", strength, " AR(1) INLA Spatial Map.png", sep = ""), 
       plot = model_map_shot, device = "png", path = here::here("Figures/Miscellaneous/"))

ggsave(filename = paste("Pass Before One-Timer ", strength, " AR(1) INLA Spatial Map.png", sep = ""), 
       plot = model_map_pass, device = "png", path = here::here("Figures/Miscellaneous/"))
...
```{r save}
saveRDS(model, here::here(paste("Models/Miscellaneous/One_Timer", strength, "model.Rda", sep = "_")))
```
