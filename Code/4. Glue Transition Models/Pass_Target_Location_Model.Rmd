...
# Save the mesh
saveRDS(Mesh, here::here(paste("Models/Meshes/Mesh_pass_target", strength, "prediction.Rda", sep = "_")))
```
...
model_A_matrix = inla.spde.make.A(Mesh, loc = model_coords, n.group = 5, group = pass_data$is_direct)
...
model_stack_x = inla.stack(
  ...
  data = list(y = otters_data$same_direction_x2), 
...
```{r save}
saveRDS(model_x, here::here(paste("Models/Miscellaneous/Pass_X_Location", strength, "model.Rda", sep = "_")))
```
...
model_stack_y = inla.stack(
  ...
  # Add our response variable
  data = list(y = otters_data$same_direction_y2), 
...
```{r save}
saveRDS(model_y, here::here(paste("Models/Miscellaneous/Pass_Y_Location", strength, "model.Rda", sep = "_")))
```
