...
```{r save}
saveRDS(model_x, here::here(paste("Models/Glue Models/X_Location", strength, "model.Rda", sep = "_")))
```
...
ggsave(filename = paste("Y-Location ", strength, " IID INLA Spatial Map.png", sep = ""), 
       plot = model_map_y, device = "png", path = here::here("Figures/Glue Models/"))
...
```{r save}
saveRDS(model_y, here::here(paste("Models/Glue Models/Y_Location", strength, "model.Rda", sep = "_")))
```
